...
ADD "https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-7.9.0-x64.bin" /installer/
...
RUN chmod -R 777 /installer/ \
    && cd /installer \
    && ls -la \
    && ./atlassian-jira-software-7.9.0-x64.bin -q -varfile response.varfile \
